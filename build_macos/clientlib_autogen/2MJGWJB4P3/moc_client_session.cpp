/****************************************************************************
** Meta object code from reading C++ file 'client_session.h'
**
...
#include "../../../src/client/client_session.h"
...
#error "The header file 'client_session.h' doesn't include <QObject>."
...
void ClientSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientSession::*)(bool , ServerConnectionMode )>(_a, &ClientSession::serverStatusChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void ClientSession::serverStatusChanged(bool _t1, ServerConnectionMode _t2)
{
